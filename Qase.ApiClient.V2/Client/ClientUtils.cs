...
[assembly: InternalsVisibleTo("Qase.ApiClient.V2.Test")]
...
namespace Qase.ApiClient.V2.Client
{
    ...
    public static class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is ResultStepStatus resultStepStatus)
                return ResultStepStatusValueConverter.ToJsonValue(resultStepStatus);
            if (obj is ResultStepsType resultStepsType)
                return ResultStepsTypeValueConverter.ToJsonValue(resultStepsType);
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.qase.io/v2";
