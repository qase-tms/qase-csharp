...
The NUnit reporter can auto-generate test cases and suites based on your test data. Test results from subsequent runs
...
Here's a simple example of using Qase annotations in an NUnit test:
...
To execute your NUnit tests and report the results to Qase.io, use the following command:
...
The Qase NUnit reporter can be configured in multiple ways:
