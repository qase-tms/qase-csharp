...
namespace Qase.XUnit.V3.Reporter.Tests
{
    ...
    public class ConsumeAsyncTests
    {
        ...
        /// Uses the MTP v2.0.2 3-arg constructor with parentTestNodeUid: default.
        /// </summary>
        private static TestNodeUpdateMessage CreateTestMessage(string displayName, params IProperty[] properties)
        {
            ...
            return new TestNodeUpdateMessage(new SessionUid("test-session"), testNode, parentTestNodeUid: default);
        }
            ...
            string namespaceName, string typeName, string methodName)
        {
            return new TestMethodIdentifierProperty(
                assemblyFullName: "Qase.XUnit.V3.Reporter.Tests, Version=1.0.0.0",
        ...
        public async Task ConsumeAsync_WithQaseIdsAttribute_SetsTestopsIds()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "QaseAnnotatedTestFixture", "AnnotatedTestMethod");
        ...
        public async Task ConsumeAsync_WithoutAttributes_UsesDefaultSuiteFromNamespaceAndClass()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "QaseAnnotatedTestFixture", "UnannotatedTestMethod");
            ...
            suiteTitles.Should().ContainInOrder(
                "Qase", "XUnit", "V3", "Reporter", "Tests", "QaseAnnotatedTestFixture");
        }
        ...
        public async Task ConsumeAsync_WithIgnoreAttribute_DoesNotCallAddResult()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "QaseAnnotatedTestFixture", "IgnoredTestMethod");
        ...
        public async Task ConsumeAsync_WithContextManagerSteps_RetrievesSteps()
        {
            ...
            var displayName = "Qase.XUnit.V3.Reporter.Tests.QaseAnnotatedTestFixture.UnannotatedTestMethod";
        ...
        public async Task ConsumeAsync_WithContextManagerComments_RetrievesComments()
        {
            // Arrange
            ContextManager.Clear();
            var displayName = "Qase.XUnit.V3.Reporter.Tests.QaseAnnotatedTestFixture.MethodWithTitleOnly";
            ContextManager.SetTestCaseName(displayName);
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "QaseAnnotatedTestFixture", "MethodWithTitleOnly");
        ...
        public async Task ConsumeAsync_WithClassLevelSuitesAttribute_UsesSuitesFromClass()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "ClassLevelSuiteFixture", "SomeTest");
        ...
        // =====================================================================
        // Parameterized test parameter extraction tests
        // =====================================================================
        ...
        public async Task ConsumeAsync_DataRowIntegerParams_ExtractsParamsCorrectly()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "ParameterizedTestFixture", "AddNumbers",
        ...
        public async Task ConsumeAsync_DataRowStringParams_ExtractsParamsCorrectly()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "ParameterizedTestFixture", "LoginUser",
        ...
        public async Task ConsumeAsync_DynamicDataMixedTypes_ExtractsParamsCorrectly()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "ParameterizedTestFixture", "MixedParams",
        ...
        public async Task ConsumeAsync_QuotedStringWithInnerComma_ParsedAsSingleValue()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "ParameterizedTestFixture", "SingleParam",
                new[] { "System.String" });
        ...
        public async Task ConsumeAsync_ParameterizedWithTitleAttribute_KeepsCustomTitle()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "ParameterizedTestFixture", "TitledParameterized",
                new[] { "System.Int32" });
        ...
        public async Task ConsumeAsync_ParameterizedContextManager_RetrievesStepsViaParamDisplayName()
        {
            // Arrange
            ContextManager.Clear();
            var contextDisplayName = "Qase.XUnit.V3.Reporter.Tests.ParameterizedTestFixture.AddNumbers(a: 10, b: 20)";
        ...
        public async Task ConsumeAsync_OverloadedMethodResolvedViaParameterTypeFullNames()
        {
            ...
            var methodId = CreateMethodIdentifier(
                "Qase.XUnit.V3.Reporter.Tests", "OverloadedTestFixture", "Calculate",
                new[] { "System.String" });
