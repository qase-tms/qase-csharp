...
public class StepTests
{
    ...
    {
        var pageLoaded = true;
        Assert.That(pageLoaded, Is.True, "Registration page should load");
    }
    ...
    {
        var emailSent = true;
        Assert.That(emailSent, Is.True, $"Confirmation email should be sent to {email}");
    }
    ...
    {
        Assert.That(street, Is.Not.Empty);
    }
    ...
    private void FillCityStateZip(string city, string state, string zip)
    {
        ...
        Assert.That(state.Length, Is.EqualTo(2));
        Assert.That(zip.Length, Is.EqualTo(5));
    }
    ...
    private void ConfirmOrder()
    {
        ...
        Assert.That(orderConfirmed, Is.True);
    }
