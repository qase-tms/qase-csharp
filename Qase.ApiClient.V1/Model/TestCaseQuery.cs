...
namespace Qase.ApiClient.V1.Model
{
    ...
    public class TestCaseQueryJsonConverter : JsonConverter<TestCaseQuery>
    {
        ...
        public override TestCaseQuery Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TestCaseQuery.StepsTypeEnum?> stepsType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "steps_type":
                            ...
                            if (stepsTypeRawValue != null)
                                stepsType = new Option<TestCaseQuery.StepsTypeEnum?>(TestCaseQuery.StepsTypeEnumFromStringOrDefault(stepsTypeRawValue));
                            break;
                        case "steps":
        ...
        public void WriteProperties(Utf8JsonWriter writer, TestCaseQuery testCaseQuery, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            var stepsTypeRawValue = TestCaseQuery.StepsTypeEnumToJsonValue(testCaseQuery.StepsTypeOption.Value!.Value);
            if (stepsTypeRawValue != null)
