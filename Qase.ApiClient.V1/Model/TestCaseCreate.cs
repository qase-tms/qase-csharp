    ...
    public class TestCaseCreateJsonConverter : JsonConverter<TestCaseCreate>
    {
        ...
        public override TestCaseCreate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "steps_type":
                            ...
                            if (stepsTypeRawValue != null)
                                stepsType = new Option<TestCaseCreate.StepsTypeEnum?>(TestCaseCreate.StepsTypeEnumFromStringOrDefault(stepsTypeRawValue));
                            break;
                        case "attachments":
            ...
            if (stepsType.IsSet && stepsType.Value == null)
                throw new ArgumentNullException(nameof(stepsType), "Property is not nullable for class TestCaseCreate.");
        ...
        public void WriteProperties(Utf8JsonWriter writer, TestCaseCreate testCaseCreate, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (testCaseCreate.IsManualOption.IsSet)
                writer.WriteBoolean("isManual", testCaseCreate.IsManualOption.Value!.Value);

            if (testCaseCreate.IsToBeAutomatedOption.IsSet)
                writer.WriteBoolean("isToBeAutomated", testCaseCreate.IsToBeAutomatedOption.Value!.Value);

            if (testCaseCreate.StatusOption.IsSet)
                writer.WriteNumber("status", testCaseCreate.StatusOption.Value!.Value);

            var stepsTypeRawValue = TestCaseCreate.StepsTypeEnumToJsonValue(testCaseCreate.StepsTypeOption.Value!.Value);
