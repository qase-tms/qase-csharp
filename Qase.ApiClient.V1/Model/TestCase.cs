...
namespace Qase.ApiClient.V1.Model
{
    ...
    /// TestCase
    /// </summary>
    public partial class TestCase : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public TestCase(Option<long?> id = default, Option<int?> position = default, Option<string?> title = default, Option<string?> description = default, Option<string?> preconditions = default, Option<string?> postconditions = default, Option<int?> severity = default, Option<int?> priority = default, Option<int?> type = default, Option<int?> layer = default, Option<int?> isFlaky = default, Option<int?> behavior = default, Option<int?> automation = default, Option<int?> status = default, Option<long?> milestoneId = default, Option<long?> suiteId = default, Option<List<CustomFieldValue>?> customFields = default, Option<List<Attachment>?> attachments = default, Option<StepsTypeEnum?> stepsType = default, Option<List<TestStep>?> steps = default, Option<TestCaseParams?> @params = default, Option<List<TestCaseParameter>?> parameters = default, Option<List<TagValue>?> tags = default, Option<long?> memberId = default, Option<long?> authorId = default, Option<DateTime?> createdAt = default, Option<DateTime?> updatedAt = default, Option<string?> deleted = default, Option<string?> created = default, Option<string?> updated = default, Option<List<ExternalIssue>?> externalIssues = default)
        {
            IdOption = id;
            ...
            ExternalIssuesOption = externalIssues;
            OnCreated();
        }
        ...
        [Obsolete]
        public string? Deleted { get { return this.DeletedOption; } set { this.DeletedOption = new Option<string?>(value); } }
        ...
        /// <summary>
        /// Used to track the state of ExternalIssues
        /// </summary>
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<ExternalIssue>?> ExternalIssuesOption { get; private set; }

        /// <summary>
        /// Gets or Sets ExternalIssues
        /// </summary>
        [JsonPropertyName("external_issues")]
        public List<ExternalIssue>? ExternalIssues { get { return this.ExternalIssuesOption; } set { this.ExternalIssuesOption = new Option<List<ExternalIssue>?>(value); } }
    ...
    /// <summary>
    /// A Json converter for type <see cref="TestCase" />
    /// </summary>
    public class TestCaseJsonConverter : JsonConverter<TestCase>
    {
        /// <summary>
        ...
        /// <summary>
        /// Deserializes json to <see cref="TestCase" />
        /// </summary>
        ...
        public override TestCase Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TestCase.StepsTypeEnum?> stepsType = default;
            ...
            Option<List<ExternalIssue>?> externalIssues = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "steps_type":
                            ...
                            if (stepsTypeRawValue != null)
                                stepsType = new Option<TestCase.StepsTypeEnum?>(TestCase.StepsTypeEnumFromStringOrDefault(stepsTypeRawValue));
                            break;
                        case "steps":
                        ...
                        case "external_issues":
                            externalIssues = new Option<List<ExternalIssue>?>(JsonSerializer.Deserialize<List<ExternalIssue>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            if (id.IsSet && id.Value == null)
                throw new ArgumentNullException(nameof(id), "Property is not nullable for class TestCase.");

            if (position.IsSet && position.Value == null)
                throw new ArgumentNullException(nameof(position), "Property is not nullable for class TestCase.");

            if (title.IsSet && title.Value == null)
                throw new ArgumentNullException(nameof(title), "Property is not nullable for class TestCase.");

            if (severity.IsSet && severity.Value == null)
                throw new ArgumentNullException(nameof(severity), "Property is not nullable for class TestCase.");

            if (priority.IsSet && priority.Value == null)
                throw new ArgumentNullException(nameof(priority), "Property is not nullable for class TestCase.");

            if (type.IsSet && type.Value == null)
                throw new ArgumentNullException(nameof(type), "Property is not nullable for class TestCase.");

            if (layer.IsSet && layer.Value == null)
                throw new ArgumentNullException(nameof(layer), "Property is not nullable for class TestCase.");

            if (isFlaky.IsSet && isFlaky.Value == null)
                throw new ArgumentNullException(nameof(isFlaky), "Property is not nullable for class TestCase.");

            if (behavior.IsSet && behavior.Value == null)
                throw new ArgumentNullException(nameof(behavior), "Property is not nullable for class TestCase.");

            if (automation.IsSet && automation.Value == null)
                throw new ArgumentNullException(nameof(automation), "Property is not nullable for class TestCase.");

            if (status.IsSet && status.Value == null)
                throw new ArgumentNullException(nameof(status), "Property is not nullable for class TestCase.");

            if (customFields.IsSet && customFields.Value == null)
                throw new ArgumentNullException(nameof(customFields), "Property is not nullable for class TestCase.");

            if (attachments.IsSet && attachments.Value == null)
                throw new ArgumentNullException(nameof(attachments), "Property is not nullable for class TestCase.");

            if (steps.IsSet && steps.Value == null)
                throw new ArgumentNullException(nameof(steps), "Property is not nullable for class TestCase.");
            ...
            if (memberId.IsSet && memberId.Value == null)
                throw new ArgumentNullException(nameof(memberId), "Property is not nullable for class TestCase.");

            if (authorId.IsSet && authorId.Value == null)
                throw new ArgumentNullException(nameof(authorId), "Property is not nullable for class TestCase.");

            if (createdAt.IsSet && createdAt.Value == null)
                throw new ArgumentNullException(nameof(createdAt), "Property is not nullable for class TestCase.");

            if (updatedAt.IsSet && updatedAt.Value == null)
                throw new ArgumentNullException(nameof(updatedAt), "Property is not nullable for class TestCase.");

            if (created.IsSet && created.Value == null)
                throw new ArgumentNullException(nameof(created), "Property is not nullable for class TestCase.");

            if (updated.IsSet && updated.Value == null)
                throw new ArgumentNullException(nameof(updated), "Property is not nullable for class TestCase.");
        ...
        /// <summary>
        /// Serializes a <see cref="TestCase" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="testCase"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, TestCase testCase, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, testCase, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="TestCase" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="testCase"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, TestCase testCase, JsonSerializerOptions jsonSerializerOptions)
        {
            if (testCase.TitleOption.IsSet && testCase.Title == null)
                throw new ArgumentNullException(nameof(testCase.Title), "Property is required for class TestCase.");

            if (testCase.CustomFieldsOption.IsSet && testCase.CustomFields == null)
                throw new ArgumentNullException(nameof(testCase.CustomFields), "Property is required for class TestCase.");

            if (testCase.AttachmentsOption.IsSet && testCase.Attachments == null)
                throw new ArgumentNullException(nameof(testCase.Attachments), "Property is required for class TestCase.");

            if (testCase.StepsOption.IsSet && testCase.Steps == null)
                throw new ArgumentNullException(nameof(testCase.Steps), "Property is required for class TestCase.");
            ...
            if (testCase.CreatedOption.IsSet && testCase.Created == null)
                throw new ArgumentNullException(nameof(testCase.Created), "Property is required for class TestCase.");

            if (testCase.UpdatedOption.IsSet && testCase.Updated == null)
                throw new ArgumentNullException(nameof(testCase.Updated), "Property is required for class TestCase.");

            if (testCase.ExternalIssuesOption.IsSet && testCase.ExternalIssues == null)
                throw new ArgumentNullException(nameof(testCase.ExternalIssues), "Property is required for class TestCase.");

            if (testCase.IdOption.IsSet)
                writer.WriteNumber("id", testCase.IdOption.Value!.Value);

            if (testCase.PositionOption.IsSet)
                writer.WriteNumber("position", testCase.PositionOption.Value!.Value);

            if (testCase.TitleOption.IsSet)
                writer.WriteString("title", testCase.Title);

            if (testCase.DescriptionOption.IsSet)
                if (testCase.DescriptionOption.Value != null)
                    writer.WriteString("description", testCase.Description);
                else
                    writer.WriteNull("description");

            if (testCase.PreconditionsOption.IsSet)
                if (testCase.PreconditionsOption.Value != null)
                    writer.WriteString("preconditions", testCase.Preconditions);
                else
                    writer.WriteNull("preconditions");

            if (testCase.PostconditionsOption.IsSet)
                if (testCase.PostconditionsOption.Value != null)
                    writer.WriteString("postconditions", testCase.Postconditions);
                else
                    writer.WriteNull("postconditions");

            if (testCase.SeverityOption.IsSet)
                writer.WriteNumber("severity", testCase.SeverityOption.Value!.Value);

            if (testCase.PriorityOption.IsSet)
                writer.WriteNumber("priority", testCase.PriorityOption.Value!.Value);

            if (testCase.TypeOption.IsSet)
                writer.WriteNumber("type", testCase.TypeOption.Value!.Value);

            if (testCase.LayerOption.IsSet)
                writer.WriteNumber("layer", testCase.LayerOption.Value!.Value);

            if (testCase.IsFlakyOption.IsSet)
                writer.WriteNumber("is_flaky", testCase.IsFlakyOption.Value!.Value);

            if (testCase.BehaviorOption.IsSet)
                writer.WriteNumber("behavior", testCase.BehaviorOption.Value!.Value);

            if (testCase.AutomationOption.IsSet)
            ...
            if (testCase.MilestoneIdOption.IsSet)
                if (testCase.MilestoneIdOption.Value != null)
                    writer.WriteNumber("milestone_id", testCase.MilestoneIdOption.Value!.Value);
                else
                    writer.WriteNull("milestone_id");

            if (testCase.SuiteIdOption.IsSet)
                if (testCase.SuiteIdOption.Value != null)
                    writer.WriteNumber("suite_id", testCase.SuiteIdOption.Value!.Value);
                else
                    writer.WriteNull("suite_id");

            if (testCase.CustomFieldsOption.IsSet)
            {
                writer.WritePropertyName("custom_fields");
                JsonSerializer.Serialize(writer, testCase.CustomFields, jsonSerializerOptions);
            }
            if (testCase.AttachmentsOption.IsSet)
            {
                writer.WritePropertyName("attachments");
                JsonSerializer.Serialize(writer, testCase.Attachments, jsonSerializerOptions);
            }
            var stepsTypeRawValue = TestCase.StepsTypeEnumToJsonValue(testCase.StepsTypeOption.Value!.Value);
            if (stepsTypeRawValue != null)
                writer.WriteString("steps_type", stepsTypeRawValue);
            else
                writer.WriteNull("steps_type");

            if (testCase.StepsOption.IsSet)
            {
                writer.WritePropertyName("steps");
                JsonSerializer.Serialize(writer, testCase.Steps, jsonSerializerOptions);
            }
            if (testCase.ParamsOption.IsSet)
            {
            ...
            if (testCase.TagsOption.IsSet)
            {
                ...
                JsonSerializer.Serialize(writer, testCase.Tags, jsonSerializerOptions);
            }
            if (testCase.MemberIdOption.IsSet)
                writer.WriteNumber("member_id", testCase.MemberIdOption.Value!.Value);

            if (testCase.AuthorIdOption.IsSet)
                writer.WriteNumber("author_id", testCase.AuthorIdOption.Value!.Value);

            if (testCase.CreatedAtOption.IsSet)
                writer.WriteString("created_at", testCase.CreatedAtOption.Value!.Value.ToString(CreatedAtFormat));

            if (testCase.UpdatedAtOption.IsSet)
                writer.WriteString("updated_at", testCase.UpdatedAtOption.Value!.Value.ToString(UpdatedAtFormat));

            if (testCase.DeletedOption.IsSet)
                if (testCase.DeletedOption.Value != null)
                    writer.WriteString("deleted", testCase.Deleted);
                else
                    writer.WriteNull("deleted");

            if (testCase.CreatedOption.IsSet)
                writer.WriteString("created", testCase.Created);

            if (testCase.UpdatedOption.IsSet)
                writer.WriteString("updated", testCase.Updated);

            if (testCase.ExternalIssuesOption.IsSet)
            {
                writer.WritePropertyName("external_issues");
                JsonSerializer.Serialize(writer, testCase.ExternalIssues, jsonSerializerOptions);
            }
        }
    }
}
