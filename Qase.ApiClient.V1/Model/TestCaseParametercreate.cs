...
namespace Qase.ApiClient.V1.Model
{
    ...
    public partial class TestCaseParametercreate : IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets ParameterShared
        /// </summary>
        public ParameterShared? ParameterShared { get; set; }

        /// <summary>
        /// Gets or Sets ParameterSingle
        /// </summary>
        public ParameterSingle? ParameterSingle { get; set; }
    ...
    public class TestCaseParametercreateJsonConverter : JsonConverter<TestCaseParametercreate>
    {
        ...
        public override TestCaseParametercreate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            ParameterShared? parameterShared = default;
            ParameterSingle? parameterSingle = default;
            ...
            while (utf8JsonReaderOneOf.Read())
            {
                ...
                {
                    Utf8JsonReader utf8JsonReaderParameterShared = utf8JsonReader;
                    ClientUtils.TryDeserialize<ParameterShared?>(ref utf8JsonReaderParameterShared, jsonSerializerOptions, out parameterShared);

                    Utf8JsonReader utf8JsonReaderParameterSingle = utf8JsonReader;
                    ClientUtils.TryDeserialize<ParameterSingle?>(ref utf8JsonReaderParameterSingle, jsonSerializerOptions, out parameterSingle);

                    Utf8JsonReader utf8JsonReaderParameterGroup = utf8JsonReader;
                    ClientUtils.TryDeserialize<ParameterGroup?>(ref utf8JsonReaderParameterGroup, jsonSerializerOptions, out parameterGroup);
                }
            }
