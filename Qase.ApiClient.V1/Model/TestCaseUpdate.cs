...
namespace Qase.ApiClient.V1.Model
{
    ...
    public partial class TestCaseUpdate : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TestCaseUpdate(Option<string?> description = default, Option<string?> preconditions = default, Option<string?> postconditions = default, Option<string?> title = default, Option<int?> severity = default, Option<int?> priority = default, Option<int?> behavior = default, Option<int?> type = default, Option<int?> layer = default, Option<int?> isFlaky = default, Option<long?> suiteId = default, Option<long?> milestoneId = default, Option<int?> automation = default, Option<bool?> isManual = default, Option<bool?> isToBeAutomated = default, Option<int?> status = default, Option<StepsTypeEnum?> stepsType = default, Option<List<string>?> attachments = default, Option<List<TestStepCreate>?> steps = default, Option<List<string>?> tags = default, Option<Dictionary<string, List<string>>?> @params = default, Option<List<TestCaseParameterCreate>?> parameters = default, Option<Dictionary<string, string>?> customField = default)
        {
    ...
    public class TestCaseUpdateJsonConverter : JsonConverter<TestCaseUpdate>
    {
        ...
        public override TestCaseUpdate Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TestCaseUpdate.StepsTypeEnum?> stepsType = default;
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "steps_type":
                            ...
                            if (stepsTypeRawValue != null)
                                stepsType = new Option<TestCaseUpdate.StepsTypeEnum?>(TestCaseUpdate.StepsTypeEnumFromStringOrDefault(stepsTypeRawValue));
                            break;
                        case "attachments":
            ...
            if (isManual.IsSet && isManual.Value == null)
                throw new ArgumentNullException(nameof(isManual), "Property is not nullable for class TestCaseUpdate.");

            if (isToBeAutomated.IsSet && isToBeAutomated.Value == null)
                throw new ArgumentNullException(nameof(isToBeAutomated), "Property is not nullable for class TestCaseUpdate.");
            ...
            if (stepsType.IsSet && stepsType.Value == null)
                throw new ArgumentNullException(nameof(stepsType), "Property is not nullable for class TestCaseUpdate.");
            ...
            return new TestCaseUpdate(description, preconditions, postconditions, title, severity, priority, behavior, type, layer, isFlaky, suiteId, milestoneId, automation, isManual, isToBeAutomated, status, stepsType, attachments, steps, tags, varParams, parameters, customField);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TestCaseUpdate testCaseUpdate, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (testCaseUpdate.IsManualOption.IsSet)
                writer.WriteBoolean("isManual", testCaseUpdate.IsManualOption.Value!.Value);

            if (testCaseUpdate.IsToBeAutomatedOption.IsSet)
                writer.WriteBoolean("isToBeAutomated", testCaseUpdate.IsToBeAutomatedOption.Value!.Value);

            if (testCaseUpdate.StatusOption.IsSet)
                writer.WriteNumber("status", testCaseUpdate.StatusOption.Value!.Value);

            var stepsTypeRawValue = TestCaseUpdate.StepsTypeEnumToJsonValue(testCaseUpdate.StepsTypeOption.Value!.Value);
