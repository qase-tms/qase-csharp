...
namespace Qase.ApiClient.V1.Model
{
    ...
    public partial class TestCaseParameterBase : IValidatableObject
    {
        ...
        [JsonConstructor]
        public TestCaseParameterBase(string type, List<ParameterSingle> items, Option<Guid?> sharedId = default)
        {
            Type = type;
            Items = items;
    ...
    public class TestCaseParameterBaseJsonConverter : JsonConverter<TestCaseParameterBase>
    {
        ...
        public override TestCaseParameterBase Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (!items.IsSet)
                throw new ArgumentException("Property is required for class TestCaseParameterBase.", nameof(items));
            ...
            if (items.IsSet && items.Value == null)
                throw new ArgumentNullException(nameof(items), "Property is not nullable for class TestCaseParameterBase.");

            return new TestCaseParameterBase(type.Value!, items.Value!, sharedId);
        }
        ...
        public void WriteProperties(Utf8JsonWriter writer, TestCaseParameterBase testCaseParameterBase, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (testCaseParameterBase.Items == null)
                throw new ArgumentNullException(nameof(testCaseParameterBase.Items), "Property is required for class TestCaseParameterBase.");

            writer.WriteString("type", testCaseParameterBase.Type);

            writer.WritePropertyName("items");
            JsonSerializer.Serialize(writer, testCaseParameterBase.Items, jsonSerializerOptions);
