...
namespace Qase.ApiClient.V1.Model
{
    ...
    /// SharedStepContent
    /// </summary>
    public partial class SharedStepContent : IValidatableObject
    {
        /// <summary>
        ...
        [JsonIgnore]
        [global::System.ComponentModel.EditorBrowsable(global::System.ComponentModel.EditorBrowsableState.Never)]
        public Option<List<AttachmentHash>?> AttachmentsOption { get; private set; }
    ...
    /// <summary>
    /// A Json converter for type <see cref="SharedStepContent" />
    /// </summary>
    public class SharedStepContentJsonConverter : JsonConverter<SharedStepContent>
    {
        /// <summary>
        /// Deserializes json to <see cref="SharedStepContent" />
        /// </summary>
        ...
        public override SharedStepContent Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (data.IsSet && data.Value == null)
                throw new ArgumentNullException(nameof(data), "Property is not nullable for class SharedStepContent.");

            if (hash.IsSet && hash.Value == null)
                throw new ArgumentNullException(nameof(hash), "Property is not nullable for class SharedStepContent.");

            if (action.IsSet && action.Value == null)
                throw new ArgumentNullException(nameof(action), "Property is not nullable for class SharedStepContent.");

            if (expectedResult.IsSet && expectedResult.Value == null)
                throw new ArgumentNullException(nameof(expectedResult), "Property is not nullable for class SharedStepContent.");
        ...
        /// <summary>
        /// Serializes a <see cref="SharedStepContent" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sharedStepContent"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, SharedStepContent sharedStepContent, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, sharedStepContent, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SharedStepContent" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="sharedStepContent"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, SharedStepContent sharedStepContent, JsonSerializerOptions jsonSerializerOptions)
        {
            if (sharedStepContent.DataOption.IsSet && sharedStepContent.Data == null)
                throw new ArgumentNullException(nameof(sharedStepContent.Data), "Property is required for class SharedStepContent.");

            if (sharedStepContent.HashOption.IsSet && sharedStepContent.Hash == null)
                throw new ArgumentNullException(nameof(sharedStepContent.Hash), "Property is required for class SharedStepContent.");

            if (sharedStepContent.ActionOption.IsSet && sharedStepContent.Action == null)
                throw new ArgumentNullException(nameof(sharedStepContent.Action), "Property is required for class SharedStepContent.");

            if (sharedStepContent.ExpectedResultOption.IsSet && sharedStepContent.ExpectedResult == null)
                throw new ArgumentNullException(nameof(sharedStepContent.ExpectedResult), "Property is required for class SharedStepContent.");
            ...
            if (sharedStepContent.HashOption.IsSet)
                writer.WriteString("hash", sharedStepContent.Hash);

            if (sharedStepContent.ActionOption.IsSet)
                writer.WriteString("action", sharedStepContent.Action);

            if (sharedStepContent.ExpectedResultOption.IsSet)
                writer.WriteString("expected_result", sharedStepContent.ExpectedResult);

            if (sharedStepContent.AttachmentsOption.IsSet)
            {
