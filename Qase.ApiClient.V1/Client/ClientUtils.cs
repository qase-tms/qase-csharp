...
[assembly: InternalsVisibleTo("Qase.ApiClient.V1.Test")]
...
namespace Qase.ApiClient.V1.Client
{
    ...
    public static class ClientUtils
    {
        ...
        public static string? ParameterToString(object? obj, string? format = ISO8601_DATETIME_FORMAT)
        {
            ...
            if (obj is bool boolean)
                return boolean
                    ? "true"
                    : "false";
            if (obj is DefectStatus.StatusEnum defectStatusStatusEnum)
                return DefectStatus.StatusEnumToJsonValue(defectStatusStatusEnum);
            if (obj is Milestone.StatusEnum milestoneStatusEnum)
                return Milestone.StatusEnumToJsonValue(milestoneStatusEnum);
            if (obj is MilestoneCreate.StatusEnum milestoneCreateStatusEnum)
                return MilestoneCreate.StatusEnumToJsonValue(milestoneCreateStatusEnum);
            if (obj is MilestoneUpdate.StatusEnum milestoneUpdateStatusEnum)
            ...
            if (obj is Requirement.TypeEnum requirementTypeEnum)
                return Requirement.TypeEnumToJsonValue(requirementTypeEnum);
            if (obj is RequirementQuery.StatusEnum requirementQueryStatusEnum)
                return RequirementQuery.StatusEnumToJsonValue(requirementQueryStatusEnum);
            if (obj is RequirementQuery.TypeEnum requirementQueryTypeEnum)
        ...
        /// </summary>
        public const string BASE_ADDRESS = "https://api.qase.io/v1";
        ...
        /// The host of the API
        /// </summary>
        public const string HOST = "api.qase.io";
